...
// Fetch all top reserved properties (grouped by property, descending order)
...
// Fetch all properties for side navigation dynamically
...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    ...
    <a href="vlogs.php" class="btn btn-outline-primary btn-sm">
      ...
      <a href="Contact Us" class="btn btn-reserve">Reach us</a>
    </div>
  </div>
</nav>
<!--CHAT BOT-->
...
<div class="hero-message">
    <h1>Iloilo Top Home Properties</h1>
    <p>
        Experience affordable and modern living in the heart of Iloilo. 
        Iloilo Top Property Homes offers quality-built homes designed for comfort, convenience, 
...
Iloilo Top Property Homes presents beautiful houses within well-planned subdivisions in Iloilo, providing a safe environment and modern living for homeowners
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="../user_side/contact_us">Reach Us</a></li>
                </ul>
            </div>
        </div>
