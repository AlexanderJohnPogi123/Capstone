...
// Fetch the top reserved property for Amani Homes
$topReservedQuery = $conn->query("
    SELECT property, COUNT(*) AS total_reserved
    FROM reservations
    WHERE property = 'amani'
    GROUP BY property
...
<div class="hero-message">
    <h1>Discover Amani House Pavia</h1>
    <p>
        Experience affordable and modern living in the heart of Pavia, Iloilo. 
       Amani House offers quality-built homes designed for comfort, convenience, 
...
<section class="recent-properties py-4" style="background:#f6f6f0;">
    <div class="container">
        <div class="row">
        <?php
        $result = $conn->query("SELECT * FROM propertiies WHERE property_page='amani' ORDER BY id DESC");
    ...
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden h-100 d-flex flex-column">
        ...
        <?php
            ...
            echo '<p class="text-center">No Amani House properties found.</p>';
        }
        ?>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="../user_side/contact_us.php">Reach Us</a></li>
                </ul>
            </div>
        </div>
