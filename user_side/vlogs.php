...
<title>Iloilo Top Property Homes - Vlogs</title>
...
<link rel="stylesheet" href="css/vlogs.css">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card vlog-card">
                ...
                <div class="card-body">
                    <h6 class="vlog-title"><?php echo htmlspecialchars($row['title']); ?></h6>
                    <div class="vlog-date"><i class="bi bi-calendar"></i> <?php echo date("F d, Y", strtotime($row['created_at'])); ?></div>
                </div>
            </div>
        </div>
        <?php endwhile; ?>
