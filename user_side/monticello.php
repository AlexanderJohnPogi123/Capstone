...
// Fetch the top reserved property for Monticello
$topReservedQuery = $conn->query("
    SELECT property, COUNT(*) AS total_reserved
    FROM reservations
    WHERE property = 'Monticello Homes Pavia'
    GROUP BY property
...
<title>Monticello Homes Pavia</title>
...
<a href="all_properties.php" class="<?php if($currentPage=='all_properties.php') echo 'active'; ?>">
All Properties
</a>
...
<a href="Amani.php" class="<?php if($currentPage=='Amani.php') echo 'active'; ?>">
Amani House
</a>
...
<div class="hero-message">
    <h1>Discover Monticello Homes Pavia</h1>
    <p>
        Experience affordable and modern living in the heart of Pavia, Iloilo. 
        Monticello Homes offers quality-built homes designed for comfort, convenience, 
        and a growing community perfect for families and future homeowners.
    </p>
</div>

<!-- Monticello Listings -->
<section class="recent-properties py-4" style="background:#f6f6f0;">
    <div class="container">
        <div class="row">
        <?php
        $result = $conn->query("SELECT * FROM propertiies WHERE property_page='monticello' ORDER BY id DESC");

        if($result->num_rows > 0){
            while($prop = $result->fetch_assoc()){
                // Decrypt property info
                ...
                if(empty($images) && !empty($prop['display_image'])){
                    $images[] = decrypt_data($prop['display_image']);
                }
                if(!empty($images[0])) $first_image = $images[0];
        ?>
            <div class="col-md-4 mb-4">
                <a href="view_property.php?id=<?= $prop['id'] ?>" class="text-decoration-none text-dark d-block h-100">
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden h-100 d-flex flex-column">
        ...
        <div class="card-body d-flex flex-column">
            ...
            <div class="card-footer-info mt-auto w-100">
        ...
        <?php
            ...
            echo '<p class="text-center">No Monticello properties found.</p>';
        }
        ?>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 mb-4">
                <h6>Properties</h6>
                <ul class="list-unstyled">
                    <li><a href="">Monticello</a></li>
                    <li><a href="../user_side/parc_regency.php">Parc Regency</a></li>
                    <li><a href="../user_side/Amani.php">Amani House</a></li>
                </ul>
            </div>
